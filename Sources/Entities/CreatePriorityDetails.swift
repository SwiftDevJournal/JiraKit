...
public struct CreatePriorityDetails: Codable {
    ...
    public init(name: String, description: String? = nil, iconURL: IconURL? = nil, statusColor: String) {
        self.name = name
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.statusColor = try values.decode(String.self, forKey: "statusColor")
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try values.encode(statusColor, forKey: "statusColor")
    }
}
