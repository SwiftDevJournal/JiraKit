...
public struct FilterSubscriptionsList: Codable {
    ...
    public init(size: Int32? = nil, items: [FilterSubscription]? = nil, maxResults: Int32? = nil, startIndex: Int32? = nil, endIndex: Int32? = nil) {
        self.size = size
        self.items = items
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.items = try values.decodeIfPresent([FilterSubscription].self, forKey: "items")
