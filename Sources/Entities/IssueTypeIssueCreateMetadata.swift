...
public struct IssueTypeIssueCreateMetadata: Codable {
    ...
    public init(this: String? = nil, id: String? = nil, description: String? = nil, iconURL: String? = nil, name: String? = nil, isSubtask: Bool? = nil, avatarID: Int? = nil, entityID: UUID? = nil, hierarchyLevel: Int? = nil, scope: Scope? = nil, expand: String? = nil, fields: [String: FieldMetadata]? = nil) {
        self.this = this
        self.id = id
