...
public struct PageBeanFieldConfigurationIssueTypeItem: Codable {
    ...
    public init(this: URL? = nil, nextPage: URL? = nil, maxResults: Int32? = nil, startAt: Int64? = nil, total: Int64? = nil, isLast: Bool? = nil, values: [FieldConfigurationIssueTypeItem]? = nil) {
        self.this = this
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.values = try values.decodeIfPresent([FieldConfigurationIssueTypeItem].self, forKey: "values")
    }
