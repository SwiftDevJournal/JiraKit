...
public struct PageBeanVersion: Codable {
    ...
    public init(this: URL? = nil, nextPage: URL? = nil, maxResults: Int32? = nil, startAt: Int64? = nil, total: Int64? = nil, isLast: Bool? = nil, values: [Version]? = nil) {
        self.this = this
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.values = try values.decodeIfPresent([Version].self, forKey: "values")
    }
